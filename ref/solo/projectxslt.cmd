...
:: getdatetime
:: xslt
call :getfiledatetime tasksdate "%projectsetupfolder%\project.tasks"
call :getfiledatetime xsltdate "%xsltpath%\project.xslt"
...
if "%lastprojectpath%" == "%projectpath%" (
  ...
  if %tasksdate% GTR %xsltdate% (
    ...
    echo.
    call :xslt vimod-projecttasks2variable "projectpath='%projectpath%'" blank.xml "%xsltpath%\project.xslt"
